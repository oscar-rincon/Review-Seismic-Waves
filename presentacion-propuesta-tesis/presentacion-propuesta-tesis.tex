...
Se define como una composición de otras funciones 
\(g_{i}(x)\), cada una de las cuales representa una transformación aplicada a la entrada $x$:
\[
f(x) = g_n(g_{n-1}(\ldots g_2(g_1(x))\ldots)).
\]
Cada función $g_i(x)$ puede representarse como:
\[
