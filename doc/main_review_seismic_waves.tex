...
\begin{tcolorbox}[colback=gray!20, colframe=gray!20, sharp corners]
    ...
    \begin{abstract}
        ...
        \noindent
        % Abstract content      
        Wave propagation modeling through standard numerical modeling methods have demonstrated notable accuracy; 
        however, their computational cost can be substantial. Recently, alternative methods based 
...
to standard numerical methods, similar to the criteria established by \citeauthoryear{mcgreivy_weak_2024}. Additionally, 
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth]{figs/scheme_systematic_review_ben_diagram.pdf}
