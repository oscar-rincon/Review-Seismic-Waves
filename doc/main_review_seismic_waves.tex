...
In order to answer the research question, We included research articles that reported a comparison of 
computational efficiency relative to standard numerical methods, similarly to the approach of 
...
cases, either a quantitative or qualitative comparison was required. Therefore we excluded studies that compare 
...
A manual screening was conducted by reviewing titles and abstracts to ensure that the publications met 
the inclusion criteria. Additionally, cited references were reviewed to identify any further relevant 
...
information to address the research question. The articles were summarized based on several criteria, 
...
\begin{table}[h!]
    ...
    \hline
    \multicolumn{1}{|l||}{\textbf{Article}} & \multicolumn{1}{c|}{\textbf{MLBM}} & \multicolumn{1}{c|}{\textbf{Wave Equation}}  & \multicolumn{1}{c|}{\textbf{Approach}}& \multicolumn{1}{c|}{\textbf{Dataset}} & \multicolumn{1}{c|}{\textbf{Outcome}} \\
    \hline
    \hline
