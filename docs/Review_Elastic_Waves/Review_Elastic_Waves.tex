%------------------------------------------------------------------------------------------------------------------------
% File: Review_Elastic_Waves.tex
% Purpose: Literature review of recent advances in modeling elastic wave 
% propagation using machine learning-based methods
% Author: oscar-rincon
...
\includegraphics{figs/forward_inverse_modeling_waves.pdf}
    ...
    scenario, the inputs $(x,t;\lambda)$ are employed to characterize a model across PDEs. Subsequently, the PDEs are resolved through 
...
%------------------------------------------------------------------------------------------------------------------------
\section{Standard Numerical Methods}\label{sec:tnm}
...
elastic wave propagation. We addressed the following research question: In which computational seismilogy applications 
