...
\usepackage[body={17cm, 24cm},headheight=1mm]{geometry}
\geometry{
  top=2cm, % Top margin
...
%			bottom=20mm,
%			headsep=11mm,
%			%showframe,%para incluir líneas de caja.
%			headheight=5mm,
%			centering]{geometry}
%--------------------------------------------------------------------------------------------------------------------------------
\usepackage[margin=1cm]{caption}

\captionsetup[figure]{font={sf, small},labelfont={normal,small,bf},labelsep=period}
%\captionsetup[figure]{
%  font={sf, small}, % Fuente sans-serif y tamaño pequeño
%  labelfont={normal,small,bf}, % Fuente normal, pequeña y negrita para la etiqueta
%%  width=22cm, % Ancho máximo del caption
%%  belowskip=-7pt, % Espacio debajo del caption
%%  aboveskip=-5pt, % Espacio arriba del caption
%%  skip=7pt, % Espacio entre el caption y el contenido
%  labelsep=period % Separador entre la etiqueta y el texto
%}
 
\usepackage{amsmath} % Paquete necesario para \boldsymbol
\usepackage{amssymb} % Paquete necesario para \mathbb
\usepackage{graphicx} % Paquete necesario para incluir gráficos
\usepackage{natbib}
...
\usepackage{fancyhdr}
% Definición del comando \iconbox
\newtcbox{\iconbox}[1][]{%
  nobeforeafter, tcbox raise base, 
  boxrule=0.4pt, top=0pt, bottom=-1pt,
  right=0.1pt, left=0.1pt, arc=1pt, boxsep=1pt,
  fontupper={\tiny \sffamily}, before upper={\vphantom{dlg}},
  colframe=white, colback=black!10!white, coltext=black, #1}

\usepackage{tikz} % Paquete necesario para dibujar líneas
\usepackage{lettrine}
...
\pagestyle{fancy}
\fancyhf{} % Borrar el estilo defecto
\renewcommand{\headrulewidth}{0pt} % Eliminar la línea horizontal del encabezado

% Configuración del encabezado
\fancyhead[LE]{\thepage\, / \textit{Machine Learning Modeling of Elastic Waves}} % Encabezado para páginas pares
\fancyhead[RO]{\textit{Introduction}\, / \thepage} % Encabezado para páginas impares

\pagenumbering{arabic} % Configuración de numeración de páginas
\setcounter{page}{1} % Establecer el número de página inicial
...
{\begin{center}
Oscar Rincón-Cardeño\textsuperscript{1,2,\iconbox{\href{https://orcid.org/0000-0002-5308-9710}{ID}},\iconbox{\href{https://github.com/oscar-rincon}{GH}}}
...
\fancyhead[RO]{\textit{Modeling of Mechanical Wave Propagation}\, / \thepage} % Encabezado para páginas impares
...
\fancyhead[RO]{\textit{Standard Numerical Methods}\, / \thepage} % Encabezado para páginas impares
...
\fancyhead[RO]{\textit{Machine learning Methods}\, / \thepage} % Encabezado para páginas impares
...
\fancyhead[RO]{\textit{Final remarks}\, / \thepage} % Encabezado para páginas impares
